...
window.onload = function () {
      ...
      $(function loadChartData() {
        $.get('/Administrator/dataCharts', function (data) {
          ...
          //console.log('can i see the 1 item in landlord :' + landlord[1]);
          //for (i = 0; i < chartSort.length; i++) {
          let val;
          let i = 0;
          for (val of chartSort){
            ...
            console.log('How many iterations chart add loop i: ' + val);
